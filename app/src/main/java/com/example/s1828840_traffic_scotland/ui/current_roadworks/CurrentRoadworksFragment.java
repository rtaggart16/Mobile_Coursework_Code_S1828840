...
package com.example.s1828840_traffic_scotland.ui.current_roadworks;
 ...
 * Class: CurrentRoadworksFragment
 * Description: Class to handle displaying the current roadworks view
 */
public class CurrentRoadworksFragment extends Fragment implements OnMapReadyCallback {
    ...
    // _currentRoadworksMap - Reference to the actual GoogleMap
    private static GoogleMap _currentRoadworksMap = null;

    // _currentRoadworksMapView - Reference to the MapView
    private static MapView _currentRoadworksMapView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_current_roadworks, container, false);

        // Call this view's top-level initialisation method
        Initialise(root);

        // Begin the current roadworks fetch
        Fetch_Current_Roadworks();
    ...
    */
    ...
    /*
     * Name: Fetch_Current_Roadworks
     * Description: Method to start the current roadworks asynchronous request
     * Params: None
     * Returns: None
     */
    public void Fetch_Current_Roadworks() {
        _taskService.Get_Current_Roadworks(null, ViewServiceEnums.C_R_Pop_Page, "");
    }
        ...
        try
        {
            ...
            if(markers.size() > 0) {
                ...
                for (MarkerOptions opt : markers) {
                    _currentRoadworksMap.addMarker(opt);
                ...
                _currentRoadworksMap.moveCamera(CameraUpdateFactory.newLatLngBounds(bounds, 70));
            ...
            else
            {
                ...
                TextView filterDateDisplay = _root.findViewById(R.id.C_R_Date_Display);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        _currentRoadworksMap = googleMap;
        ...
        _currentRoadworksMap.moveCamera(CameraUpdateFactory.newLatLngZoom(scotland, 5));
    }

    @Override
    public void onResume() {
        _currentRoadworksMapView.onResume();
        super.onResume();
    }

    @Override
    public void onPause() {
        _currentRoadworksMapView.onPause();
        super.onPause();
    }

    @Override
    public void onLowMemory() {
        _currentRoadworksMapView.onLowMemory();
        super.onLowMemory();
    }
    ...
    private void Initialise_Map(View root) {
        ...
        _currentRoadworksMapView = root.findViewById(R.id.C_R_Map);
        _currentRoadworksMapView.onCreate(null);
        _currentRoadworksMapView.getMapAsync((OnMapReadyCallback) this);
    }
    ...
    private void Initialise_UI(View root) {
        ...
        _mapViewButton = (Button) root.findViewById(R.id.C_R_Map_Btn);
        // Get the button that triggers the list display
        _listViewButton = (Button) root.findViewById(R.id.C_R_List_Btn);

        // Get the progress spinner view
        _progressView = root.findViewById(R.id.C_R_Progress);
        // Get the result view
        _resultView = root.findViewById(R.id.C_R_Result_Display);
